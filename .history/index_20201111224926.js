...
function playPreview() {
    if (previews[0].paused) {
        previews[0].play();
        for (let i = 1; i <= 10; i++) box[i].classList.add('darken');
...
function previewState() {
    if (previews[0].play) {
        previews[0].pause();
        for (let i = 1; i <= 10; i++) box[i].classList.remove('darken');
...
function playPreview2() {
    if (previews[2].paused) {
        previews[2].play();
        for (let i = 0; i <= 10; i++) box[i].classList.add('darken');
...
function previewState2() {
    if (previews[2].play) {}
    previews[2].pause();
    for (let i = 0; i <= 10; i++) box[i].classList.remove('darken');
}
