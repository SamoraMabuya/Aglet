...
function playPreview10() {
    if (previews[10].paused) {
        previews[10].play();
        for (let i = 0; i <= 11; i++) box[i].classList.add('darken');
        box[10].classList.remove('darken');
    }
}
...
function playPreview11() {
    if (previews[11].paused) {
        previews[11].play();
        for (let i = 0; i <= 11; i++) box[i].classList.add('darken');
        box[11].classList.remove('darken');
    }
}
...
var item = navLinks.getElementsByClassName("nav-item");
