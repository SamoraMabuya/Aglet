...
for (var i = 0; i < btns.length; i++) {
    btns[i].addEventListener("click", function() {
        ...
        var hover = document.getElementsByClassName('nav-link:hover:after')
        current[0].className = current[0].className.replace(" active", "").className.remove('nav-link:hover:after');
